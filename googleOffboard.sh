...
then
    # In lieu of local documentation, you can link any you find on the interwebs
    printf "GAM is not installed. Please install it by following our Wiki: <insert_local_documentation_link> \n\n"
    exit 0
elif [ -d "$HOME/bin/gam" ]
then
    # In lieu of local documentation, you can link any you find on the interwebs
    printf "Only GAM is installed. Please install 'GAM ADV' via: https://github.com/taers232c/GAMADV-XTD3/wiki/How-to-Upgrade-from-Standard-GAM or reset your Cloud Shell then follow our Wiki: <insert_local_documentation_link> \n\n" \n\n"
    exit 0
...
emailPattern='^[a-zA-Z0-9._%+-]+@domain\.com$'
...
# IT Calendar
itCal="c_g4lrrp29bndu238tl4l1jc6o7g@group.calendar.google.com"
# 90 Days from today
...
sharedDriveId="<insert_sharedDrive_ID_here>"
destinationFolderId="<insert_sharedDrive_Folder_ID_here>"
credentialsFile="$HOME/.gam/<credential_file_name>.json"
pyScript="$HOME/.gam/<python_script_file_name>.py"
